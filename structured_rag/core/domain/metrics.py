...
class GenerateAnswerTaskMetric:
    """Uses DSPy + GPT-4 to assess answer alignment. Lazy-imports dspy."""
    ...
    def _init_assessor(self):
        ...
        class AssessAnswerAlignment(dspy.Signature):
            ...
            score_rationale: str = dspy.OutputField(description="The rationale for the alignment score.")
            alignment_score: int = dspy.OutputField(description="The alignment score on an integer scale of 0 to 5.")

        self.assess_answer_alignment = dspy.TypedPredictor(AssessAnswerAlignment)
    ...
    def assess_answer_metric(self, context: str, question: str, system_answer: str, ground_truth: str) -> Tuple[int, str]:
        ...
        with dspy.context(lm=self.gpt4):
            metric_output = self.assess_answer_alignment(
                context=context, question=question,
                system_answer=system_answer, ground_truth=ground_truth
            )
